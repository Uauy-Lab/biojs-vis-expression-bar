...
var ExpressionBar = function (options) {
 ...
 this._container.append(' Group: <select id="'+this.opt.target+'_group"></Select>');
...
ExpressionBar.prototype.renderPropertySelector = function(){
 ...
 this.property_selector.val(this.opt.renderGroup);

 this.property_selector.on("change", function(event) { 
    console.log("Changing");
     self.opt.renderGroup = self.property_selector.find(":selected").text();;
