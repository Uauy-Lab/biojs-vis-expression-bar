...
TernaryPlot.prototype.renderGeneBar = function(i){ 
  ...
  // Creating an array of maps that hold all the data needed for visualisation
    ...
    this._indicateExpressionBias(expressionBias, this.parent.opt.renderProperty);
...
TernaryPlot.prototype._indicateExpressionBias = function(expressionBias, renderProperty){

  if(renderProperty == 'count'){
    ...
    for(var i=0; i<numOfBlockRows; i++){
      ...
      $(`#block-group-${i}`).on('mouseenter', function(){
        ...
        self._showExpBiasTooltip(tooltipTextArr[indexOfRow], this);
