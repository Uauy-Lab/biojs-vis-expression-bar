...
TernaryPlot.prototype._responseToScroll = function(){
  ...
  var lastScrollLeft = 0;  
    ...
    if (lastScrollLeft != documentScrollLeft){      
      ...
      d3.select(`#${chartSVGidHead}`).style(`position`, 'relative');
      d3.select(`#${chartSVGidHead}`).style(`left`, -lastScrollLeft);
...
TernaryPlot.prototype._calculateplotSize = function(){    
  var labelWidth = this.opt.labelWidth;
  var plotContainerHeight = $(`#${this.parent.plotContainer}`).outerHeight() - 10;
