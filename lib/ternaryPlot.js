...
TernaryPlot.prototype.renderGlobalScale = function(){
  ...
  console.log(`labelWidth: ${this.opt.labelWidth}\nternary side: ${opt.side}\nternary height: ${opt.height}\nternary width: ${opt.width}\nwindow width: ${$(document).width()}\nwindow height: ${window.innerHeight}\nOFF: ${$(window).width() - (opt.width + this.opt.labelWidth)}`);
  ...
  // Initialising local variables
    ...
    opt.width = $(document).width() - this.opt.labelWidth;
    opt.height = window.innerHeight;
    opt.side = opt.width / 2;

    console.log(`labelWidth: ${this.opt.labelWidth}\nternary side: ${opt.side}\nternary height: ${opt.height}\nternary width: ${opt.width}\nwindow width: ${$(document).width()}\nwindow height: ${window.innerHeight}\nOFF: ${$(window).width() - (opt.width + this.opt.labelWidth)}`);

  // Fix the position of the div conatainer of the ternary plot
    plotContainer = d3.select('#' + this.selector);              
    plotContainer.attr(`style`, `position:fixed; bottom: ${-250}px; left: ${labelWidth}px;`);
