...
ExpressionBar.prototype.setDefaultOptions = function(){
  this.opt = {
   ...
   titleGroupSpace: ($(window).height() * 0.017)
  }; 
}
...
ExpressionBar.prototype.refreshTitles = function(){
  ...
  .attr('y', function(d,i){
    ...
    return (((pos ) * titleGroupSpace) ) + headerOffset;
  });
  ...
  .attr('y', function(d,i){
   ...
   return (((pos) * titleGroupSpace)) + headerOffset + 10;
 });
...
ExpressionBar.prototype.renderChartScale = function(){  
  var scaleContent = `
  <div id="group_title_horizontal_scale" class="size_scales"><h3>Group Title Horizontal Scale</h3></div>
  <div id="group_title_vartical_scale" class="size_scales"><h3>Group Title Vertical Scale</h3></div>
  `;
  var chartScales = $(`#${this.chartScale}`);
  ...
  chartScales.find('#group_title_horizontal_scale').slider({
    ...
    change: function(event) {
      var value = chartScales.find('#group_title_horizontal_scale').slider("value");      
  ...
  chartScales.find('#group_title_vartical_scale').slider({
    ...
    change: function(event) {
      var value = chartScales.find('#group_title_vartical_scale').slider("value");      
      eb.opt.titleGroupSpace = value;                  
      var svgHeight = $("#bar_expression_viewer_chart_svg").height();
      svgHeight += value;
      // $("#bar_expression_viewer_chart_svg").height(svgHeight);
      console.log(`${$("#bar_expression_viewer_chart_svg").height()}`);
      eb.refreshSVG();      
    }
  });      
}
