...
ExpressionBar.prototype.renderFactorTitles = function(){
  ...
  // Setting the size of the header offset and the position as the longest factor title  
  this.opt.headerOffset = longestFactorTitle ;
  this.chartHead.attr('height', this.opt.headerOffset); 
  this.factorTitle.attr('transform', `translate(0, ${longestFactorTitle})`);
...
ExpressionBar.prototype.renderChartScale = function(){  
  ...
  <div id="bar_size_slidebar" class="size_scales"><h3>Bar Size</h3></div>
  `;
