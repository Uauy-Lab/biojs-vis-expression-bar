...
ExpressionBar.prototype.renderGeneTitles = function(i){  
  ...
  if(rotated && renderedTextWidth > this.opt.headerOffset){
    console.log(`bar height: ${this.opt.barHeight}\nheaderoffset: ${this.opt.headerOffset}\nrenderedtextwidth: ${renderedTextWidth}`);
    newHeigth =  0.75 * this.opt.barHeight * (this.opt.headerOffset/renderedTextWidth);      
    console.log(`we are here at that condition`);       
  }
  ...
  if(renderedTextHeight > blockWidth ){
    ...
    console.log(`WE ARE SETTING THE FONT SIZE: ${newHeigth}`);
