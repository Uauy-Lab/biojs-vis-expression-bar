...
ExpressionBar.prototype.showTooltip = function(mouseovertext, evt) {  
  ...
  if(match){
    ...
    for(var i=0; i<stringBroken.length; i++){
      ...
      $("#bar_expression_viewer_chart_svg").get(0).appendChild(clonedNode);
  ...
  this.tooltipBox.attr('width', maxTextBoxWidth + (padding*2));  
  this.tooltipBox.attr('height', textBoxHeight + (padding*2));
