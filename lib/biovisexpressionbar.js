...
ExpressionBar.prototype.setupContainer = function(){
 ...
 this._container.append('<input id="' +  this.opt.target +
  '_showHomoeologues" type="checkbox" name="showHomoeologues" value="show">Homoeologues </input>')
...
ExpressionBar.prototype.saveRenderedData = function(self){
  ...
  console.log(output);
  self.saveTextFile("renderedData.tsv", output);
};
