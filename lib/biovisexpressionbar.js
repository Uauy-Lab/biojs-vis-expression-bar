...
ExpressionBar.prototype.renderFactorTitles = function(){
  ...
  var optionPos = $("#bar_expression_viewer_options").position().top;
  var optionHeight = $("#bar_expression_viewer_options").height();  

  // All my trouble**********************************************
  var factorTitlePosition = this.opt.fonstSize + optionPos + optionHeight;

  this.factorTitle.attr('transform', `translate(0, ${factorTitlePosition})`);
  // All my trouble**********************************************

  
  console.log(`\noptions bar position = ${optionPos}
  The height of the options bar = ${optionHeight}
  FINAL POSITION:  Fonst Size = ${factorTitlePosition}
  `);
...
ExpressionBar.prototype.renderChartScale = function(){  
  var scaleContent = `
  <div id="group_title_horizontal_scale" class="size_scales"><h3>Font Size</h3></div>
  <div id="group_title_vartical_scale" class="size_scales"><h3>Bar Size</h3></div>
  `;
