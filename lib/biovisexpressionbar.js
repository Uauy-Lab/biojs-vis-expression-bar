...
//  console.log(axisScale);
  ...
  toUpdate.transition().duration(1000).ease("sin-in-out").call(xAxis);//ease("sin-in-out")  // https://github.com/mbostock/d3/wiki/Transitions#wiki-d3_ease
