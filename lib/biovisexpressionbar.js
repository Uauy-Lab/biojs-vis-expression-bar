...
ExpressionBar.prototype.resizeChart =  function(){  
  ...
  bev.css('width', (parentWidth - 40));
  headSVG.css('width', (parentWidth - 40));
  sortDiv.css('width', (parentWidth - 40));
  chartSVG.css('width', (parentWidth - 40));
  footerSVG.css('width', (parentWidth - 40));
  eb.opt.width = parentWidth - 40;          
  eb.refresh();
}
