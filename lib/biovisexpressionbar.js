...
ExpressionBar.prototype.setupContainer = function(){
  ...
  <div id="${this.sortDivId}" style="position: relative; height: 35px;" ></div>
  </div>  
...
ExpressionBar.prototype.adjustHeight = function(newHeight){  
  ...
  var chartHeight = newHeight - sortIconHeight - headDivHeight - optionsHeight - 70; // 20 is the scale height & the rest is uncalculated margin (some components render later)    
...
ExpressionBar.prototype.adjustWidth = function(newWidth){
  ...
  var parentWidth = parentElem.outerWidth() - 30; // 30 is the scrollbar width    
  if(parentWidth < 900){
    this.opt.width = 1500;
  } else {
